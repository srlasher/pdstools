Many of the plot functions from the CDH Tools library are put together in a single R notebook that performs a standard analysis of the models, propositions and predictors from the ADM datamart.
