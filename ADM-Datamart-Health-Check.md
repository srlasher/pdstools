...
4. Open the notebook "examples/datamart/healthcheck.Rmd" in R Studio and "Knit with Parameters". When finished (it takes a few minutes), the report should open in a browser window. It will also be saved automatically in your working folder. This stand-alone HTML (or PDF) file can then easily be distributed.

| Knit option in R Studio | Knit dialog for the Health Check notebook |
| :---: | :---: |
| <img src="/pegasystems/cdh-datascientist-tools/blob/master/images/R-studio-healthcheck-knit-with-params.png" width="60%" height="60%"> | <img src="/pegasystems/cdh-datascientist-tools/blob/master/images/R-studio-healthcheck-knit-dialog.png" width="60%" height="60%"> |
